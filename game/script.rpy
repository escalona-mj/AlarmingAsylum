...
label start:
    ...
    label char_intro:
        ...
        i "You and your never-ending love for reading. Alright, sure."
        ...
        raymon r_mouth_slightopen "There's a lot to take in."
        show raymon -r_mouth_slightopen
        i "I-is that so?"
        "I never thought he'd come prepared."
        raymon r_eyes_closedhappy r_mouth_open "Of course! I'm always prepared."
        i "So, what made you take all of the books here?"
        raymon -r_eyes_closedhappy "I find these a bit mesmerizing. I took the books that caught my attention."
        ...
        raymon -r_mouth_slightopen -r_eyes_closed"It's about a group of students using an abandoned mansion as their retreat center."
